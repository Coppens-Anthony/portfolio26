...
return [
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'Le :attribute donné est apparu dans une fuite de données. Merci de choisir un autre :attribute.',
    ],
    ...
    /*
    |--------------------------------------------------------------------------
    | Lignes de langage personnalisées
    |--------------------------------------------------------------------------
    |
    | Vous pouvez spécifier ici des messages de validation personnalisés
    | pour des attributs en utilisant la convention "attribute.rule" pour
    | nommer les lignes. Cela permet de définir rapidement un message
    | spécifique pour une règle donnée sur un attribut donné.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Les lignes suivantes permettent de remplacer le nom des attributs par
    | quelque chose de plus lisible, comme "Adresse e-mail" au lieu de
    | "email". Cela aide simplement à rendre nos messages plus explicites.
    |
    */
